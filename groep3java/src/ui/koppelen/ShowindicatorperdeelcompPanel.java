 ...
 * @author alexander
 */
public class ShowindicatorperdeelcompPanel extends JPanel
{
     private JTable jt;
   ...
   private JLabel lbluitleg;
    ...
    public ShowindicatorperdeelcompPanel() throws SQLException
    {
        super();
    ...
    private void addComponents() throws SQLException 
    {
        ...
        lbluitleg.setText("Toon Indicator per Deelcompetentie:");
    ...
    {   deelCompetentiesDAO cd = new deelCompetentiesDAO();
        ...
        IndicatorenDAO pd = new IndicatorenDAO();
                ...
                try
                {
                    for(Object em:(ArrayList)pd.getIndicatorenPerDeelcomp(x))
                ...
                {
                     sp.getViewport().remove(jt);
                     JOptionPane.showMessageDialog(this, "Geen indicatoren gekoppeld aan deze Deelcompetentie","ERROR",JOptionPane.ERROR_MESSAGE);
                }
            }  
